...
//Stock item
router.get("/stockItem/:page",getStockItemList);//get stock item list
...
//Category
router.get("/category/:page",getCategoryList);//get category list
router.get("/category/:page",getCategory);//get category 
...
router.get("/category/?search", );// search category
...
//supplier
router.get("/supplier/:page",getSupplierList);//get supplier list
