...
const {description,customerId ,eventId, payment, offers, amount, type, status } = req.body

try {
    const pay={
        description,customerId,eventId , payment, offers, amount, type:type || "offline", status:status || "full"
    }
